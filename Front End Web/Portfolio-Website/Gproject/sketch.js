...
use w to jump, a and d to move left and right
...
{   
    ...
    if ( lives < 1 ){
        textAlign(CENTER);
        fill( 255, 255, 240);
        text('Game over. Refresh browser tab to play again.', width/2, height/2 - 50);
    }
    
    if ( flagpole.isReached == true){
        textAlign(CENTER);
        fill( 255, 255, 240);
        text('Game complete. Refresh browser tab to play again.', width/2, height/2 - 50);
    }
    ...
    // Will run startgame if lives are less than zero 
...
function startGame(){
    ...
    trees_x = [-900, -400, 100, 500, 900, 1100, 1800, 2000, 2400, 2700, 2900, 3400, 3700, 4200, 4700, 5600, 5800, 6000, 6100, 6200, 6300, 6500, 6600, 6700];
    ...
    clouds = [
        ...
        {x_pos: 4400, y_pos: 40},
        {x_pos: 4700, y_pos: 20},
        {x_pos: 4800, y_pos: 110},
        {x_pos: 5100, y_pos: 70},
        {x_pos: 5500, y_pos: 100},
        {x_pos: 5600, y_pos: 40},
        {x_pos: 5900, y_pos: 20}
    ];
    ...
    mountains = [
        ...
        {x_pos: 3600, y_pos: floorPos_y},
        {x_pos: 3900, y_pos: floorPos_y},
        {x_pos: 4000, y_pos: floorPos_y},
        {x_pos: 4400, y_pos: floorPos_y}
    ];
    ...
    canyons = [
        ...
        {x_pos: 1600, width: 90, isFound: false},
        {x_pos: 1800, width: 90, isFound: false},
        {x_pos: 2000, width: 90, isFound: false},
        {x_pos: 2300, width: 90, isFound: false},
        {x_pos: 2750, width: 90, isFound: false},
        {x_pos: 3000, width: 90, isFound: false},
        {x_pos: 3400, width: 90, isFound: false},
        {x_pos: 3600, width: 90, isFound: false},
        {x_pos: 4000, width: 90, isFound: false},
        {x_pos: 4350, width: 90, isFound: false},
        {x_pos: 4880, width: 70, isFound: false},
        {x_pos: 5000, width: 80, isFound: false}
    ];
    
    collectables = [
        {x_pos: 358, y_pos: 412, size: 0, isFound: false},
        {x_pos: 658, y_pos: 412, size: 0, isFound: false},
        {x_pos: 1450, y_pos: 412, size: 0, isFound: false},
        {x_pos: 1940, y_pos: 412, size: 0, isFound: false},
        {x_pos: 2550, y_pos: 412, size: 0, isFound: false},
        {x_pos: 2910, y_pos: 412, size: 0, isFound: false},
        {x_pos: 3550, y_pos: 412, size: 0, isFound: false},
        {x_pos: 3850, y_pos: 412, size: 0, isFound: false},
        {x_pos: 4600, y_pos: 412, size: 0, isFound: false},
        {x_pos: 4970, y_pos: 412, size: 0, isFound: false} 
    ];
    ...
    flagpole = { x_pos: 5200, isReached: false};
    ...
    enemies.push( new Enemy(830, floorPos_y, 350));
    enemies.push( new Enemy(2110, floorPos_y, 180));
    enemies.push( new Enemy(2420, floorPos_y, 300));
    enemies.push( new Enemy(3115, floorPos_y, 265));
    enemies.push( new Enemy(3720, floorPos_y, 270));
    enemies.push( new Enemy(4120, floorPos_y, 200));
    enemies.push( new Enemy(4470, floorPos_y, 380));
}
...
function Enemy(x,y,range){
    ...
    this.draw = function(){
        ...
        noStroke();
        fill(100,50,100);
        rect( this.current_x, this.y - 30, 20, 20);             // Right torso
        rect( this.current_x, this.y - 30, -20, 20);            // Left torso
        rect( this.current_x - 20, this.y - 10, 10, 10);        // Left leg
        rect( this.current_x + 10, this.y - 10, 10, 10);        // Right leg
        rect( this.current_x + 10, this.y - 40, 10, 10);        // Head
        ellipse( this.current_x - 20, this.y - 30, 10);         // Tail
        fill(0);
        ellipse( this.current_x + 15, this.y - 34, 3);
        stroke(0); 
        line( this.current_x + 13, this.y - 38, this.current_x + 17, this.y - 36);
    ...
    this.update = function(){
        ...
        this.isContact = function( gc_x, gc_y){
            ...
            // this returns ture if contact is made 
...
// Refresh the page to play again or start over.