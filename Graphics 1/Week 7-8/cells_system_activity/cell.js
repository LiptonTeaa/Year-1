  ...
  // handle position
    ...
    this.update = function() {
      ...
      // 2. add the velocity to the position to "move" the cell
        ...
        // Subtracting to decrease cell life every time update is called 
        this._life -= 1;
    ...
    // Additions to make getting cell properties easier, like for the getter function for diameter
    
    this.getPosition = function()
    {
        return this._position; // Cell's current position as a 3d vetor 
    }
    
    this.getLife = function()
    {
        return this._life; // Cell's current life 
    }
