...
function setup()
{
    ...
    collectable = {x_pos: 358, y_pos: 412, size: 0, isFound: false}
}
...
function draw()
{
    ...
    if ( (gameChar_x >= 160 && gameChar_x <= 250) && gameChar_y >= floorPos_y){
        isPlummeting = true;
    }
    ...
    if( collectable.isFound == false){
        ...
        fill(255);
        stroke(0);
        rect(collectable.x_pos, collectable.y_pos, 5 + collectable.size, 12 + collectable.size, 30); 
...
//    if ((isFalling == true) && gameChar_y == floorPos_y){  //   EDIT CODE
//        gameChar_y -= 100;
//    }
